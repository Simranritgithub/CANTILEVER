    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <GlassCard className="w-full max-w-md text-black">
        ...
        <p className="text-center mb-6 text-[#9929EA]">
          Join <span className="font-bold text-[#9929EA]">Sampark</span> and
          start connecting
        </p>

        {/* Form */}
        <form
          onSubmitCapture={handleOnCapture}
        ...
        <p className="text-center text-sm text-black">
          ...
          <span
            ...
            className="text-[#edcc10] font-bold cursor-pointer hover:underline text-base"
          >
            Login
          </span>
        </p>
